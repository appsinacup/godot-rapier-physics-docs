...
| | <img src="/img/engines/rapier.svg" alt="Rapier" height="22" /><br />Rapier2D | <img src="/img/engines/box2d.svg" alt="Box2D" height="22" /><br />Box2D |
|-|-|-|
| ![pyramid](/img/benchmarks/2d_pyramid.png) | **16&nbsp;ms**<br />1.8&nbsp;cores | 17&nbsp;ms<br />4.1&nbsp;cores |
...
| ![joints](/img/benchmarks/2d_joint_grid.png) | 6.4&nbsp;ms<br />1.6&nbsp;cores | **3.8&nbsp;ms**<br />2.8&nbsp;cores |

| Benchmark | Conclusion |
|-|-|
| Pyramid | **Rapier 1.05x faster**, 2.3x fewer cores |
...
| Joint grid | **Box2D 1.69x faster**, Rapier 1.8x fewer cores |
...
| ![joints](/img/benchmarks/3d_joint_grid.png) | 11.4&nbsp;ms<br />2.3&nbsp;cores | timeout (>60s) | **11.2&nbsp;ms**<br />1.0&nbsp;cores |
...
| Joint grid | Box3D and Rapier tie, Jolt cannot finish |
